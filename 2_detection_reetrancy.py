...
def get_ast_from_solidity(source_code, solc_version="0.4.24"):
    ...
    for func, body in functions.items():
        ...
        while visit_stack:
            ...
            if node_name == "FunctionCall":
                ...
                if expression.get("name") == "MemberAccess":
                    express = expression.get("children", [{}])[0]
                    
                    member_name = express.get("attributes", {}).get("member_name", "")
            ...
            # Detect state changes (ExpressionStatement or Assignment)
